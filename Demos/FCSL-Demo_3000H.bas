...
420 CALL %3000; REM INIT Smiley0

430 LET Z=1, X=152, Y=8, W=%E003+(Z*260)
440 CALL %3000; REM INIT Smiley1

450 LET Z=2, X=232, Y=89, W=%E003+(Z*260)
460 CALL %3000; REM INIT Smiley2

470 LET Z=3, X=153, Y=169, W=%E003+(Z*260)
480 CALL %3000; REM INIT Smiley3
490 RETURN
...
505 LET Z=0; CALL %300C; REM WALK

510 LET Y=Y+1; Y=(Y $AND 3) $OR 4
515 LET Z=1; CALL %300C; REM WALK

520 LET Y=Y+1; Y=(Y $AND 3) $OR 4
525 LET Z=2; CALL %300C; REM WALK

530 LET Y=Y+1; Y=(Y $AND 3) $OR 4
535 LET Z=3; CALL %300C; REM WALK
540 RETURN
